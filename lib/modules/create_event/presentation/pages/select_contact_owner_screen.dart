...
class SelectOwnerContact extends GetView<CreateEventController> {
  const SelectOwnerContact({Key? key}) : super(key: key);
          ...
          children: [
                                ...
                                trailing: element.userData == null
                                    ...
                                    : Obx(() {
                                        return Radio(
                                          ...
                                          groupValue: controller.OwnerID.value,
                                          onChanged: (value) =>
            ...
            Padding(
              ...
              child: CustomElevatedButton(
                title: 'NEXT',
                onPressed: () => controller.validateSelectOwner(),
              ),
            )
          ],
        ));
